odoo.define('oejia.Menu', function (require) {
"use strict";
...
var Menu = Widget.extend({
	...
	load_systray_menu: function(){
		this.systray_menu = new SystrayMenu(this);
		return this.systray_menu.attachTo(this.$el.parents().find('#o_menu_systray'));
	},
    ...
    change_menu_section: function (primary_menu_id) {
        this.on_change_top_menu(primary_menu_id)
    },
});
